...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/generic_parser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14598&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/generic_parser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `generic_parser` can be installed with:

```
conda install generic_parser
```

It is possible to list all of the versions of `generic_parser` available on your platform with:
